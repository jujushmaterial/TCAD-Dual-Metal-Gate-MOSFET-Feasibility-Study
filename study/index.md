...
- [프로젝트 첫 페이지](../)
- [최종 발표 PDF](../presentation/final_conference_presentation.pdf)
- [원본 PPTX](../presentation/final_conference_presentation.pptx)
- [전체 TCAD 코드](../source/)
- [결과 데이터](../results/)
...
![Planar MOSFET에서 GAA와 CFET으로 이어지는 기술 흐름](../figures/presentation/slide_02_technology_context.png)
...
![최종 발표에서 사용한 DMG 해결방안](../figures/presentation/slide_09_dmg_solution.png)
...
![최종 발표의 연구 가설](../figures/presentation/slide_10_research_hypothesis.png)
...
![최종 발표의 SProcess 구현 설명](../figures/presentation/slide_12_sprocess_implementation.png)
...
![실제 SProcess checkpoint montage](../figures/actual/process/dmg_sprocess_montage_lg_0p25.png)
...
![Lg 0.25 μm Low-Vd와 High-Vd transfer curve](../figures/actual/scaling/lg_0p25_transfer_curve.png)
...
![Lg 0.25 μm parameter screening](../figures/presentation/slide_13_lg_0p25_parameter_screening.png)

### Selected condition

![Lg 0.25 μm 선정 조건과 baseline 비교](../figures/presentation/slide_13_lg_0p25_selected_condition.png)
...
![Lg 0.10 μm Low-Vd와 High-Vd transfer curve](../figures/actual/scaling/lg_0p10_transfer_curve.png)
...
![Lg 0.10 μm parameter screening](../figures/presentation/slide_14_lg_0p10_parameter_screening.png)

### Selected condition

![Lg 0.10 μm 선정 조건과 Single–Dual 비교](../figures/presentation/slide_14_lg_0p10_selected_condition.png)
...
![Lg 0.028 μm Low-Vd와 High-Vd transfer curve](../figures/actual/scaling/lg_0p028_transfer_curve.png)
...
![Lg 0.028 μm 구조 안정성을 포함한 parameter screening](../figures/presentation/slide_15_lg_0p028_parameter_screening.png)

### Selected condition

![Lg 0.028 μm scaling-stage selected condition](../figures/presentation/slide_15_lg_0p028_selected_condition.png)
...
![Scaling 결과와 DIBL 신뢰성 검토](../figures/presentation/slide_16_scaling_result_and_reliability.png)

[세 gate length의 최적화 과정 자세히 보기](../appendix/optimization_details.html)
...
![최종 발표의 gate leakage 문제](../figures/presentation/slide_17_gate_leakage_problem.png)
...
![High-K 공정 구현](../figures/presentation/slide_18_highk_process.png)

![High-K 적용 전후 gate leakage 결과](../figures/presentation/slide_19_highk_leakage_result.png)
...
![실제 ratio 구조와 curve](../figures/presentation/slide_21_gate_ratio_structures_and_curves.png)
...
![Gate-ratio raw data 비교](../figures/presentation/slide_22_gate_ratio_raw_comparison.png)

![Gate-ratio 원인 해석](../figures/presentation/slide_23_gate_ratio_interpretation.png)
...
![최종 학회 발표 결론](../figures/presentation/slide_24_conclusion.png)
